...
public class CompletedAdapter extends RecyclerView.Adapter<CompletedAdapter.ViewHolder> {
    ...
    public CompletedAdapter(ArrayList<TodoResponse> data) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_todo_progress, viewGroup, false);

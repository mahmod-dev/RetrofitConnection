...
import com.mahmouddev.retrofitconnection.adapter.InProgressAdapter;
...
public class InProgressFragment extends Fragment {
    ...
    public InProgressFragment(int id) {
        this.id = id;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<ArrayList<TodoResponse>> call = service.getTodoByUserId(id,false);
    ...
    public void initRecycleView() {
        ...
        InProgressAdapter adapter = new InProgressAdapter(usersResponses);
